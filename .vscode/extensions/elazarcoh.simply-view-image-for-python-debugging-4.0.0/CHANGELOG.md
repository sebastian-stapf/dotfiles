...
- Register debug-adapters with the new `debugpy` type (`python` is deprecated). Fixes [#82](https://github.com/elazarcoh/simply-view-image-for-python-debugging/issues/82).
